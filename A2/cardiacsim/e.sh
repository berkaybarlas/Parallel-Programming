...
echo "1 MPI n=256"
mpirun -np 1 ./cardiacsim -n 256 -t 10000 -x 1 -y 4

echo "Serial version ..."
./cardiacsim-serial -n 512 -t 5000
echo "2 MPI n=256"
mpirun -np 2 ./cardiacsim -n 512 -t 5000 -x 1 -y 2

echo "Serial version ..."
./cardiacsim-serial -n 1024 -t 2500
echo "4 MPI n=256"
mpirun -np 4 ./cardiacsim -n 1024 -t 2500 -x 1 -y 4

echo "Serial version ..."
./cardiacsim-serial -n 2048 -t 1250
echo "8 MPI n=256"
mpirun -np 8 ./cardiacsim -n 2048 -t 1250 -x 1 -y 8

echo "Serial version ..."
./cardiacsim-serial -n 4096 -t 725
echo "16 MPI n=256"
mpirun -np 16 ./cardiacsim -n 4096 -t 725 -x 1 -y 16
