...
# -= Resources =-
#
#SBATCH --job-name=b-nonex-cardiac-sim
#SBATCH --nodes=2
...
#SBATCH --time=30:00
#SBATCH --output=./outputs/b-cardiacsim-2-%j.out
...
echo "2 MPI 1 2"
mpirun -np 2 ./cardiacsim -n 1024 -t 100 -x 1 -y 2
...
echo "8 MPI 4 2"
mpirun -np 8 ./cardiacsim -n 1024 -t 100 -x 4 -y 2
